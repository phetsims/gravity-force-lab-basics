...
=============
"Gravity Force Lab: Basics" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/gravity-force-lab-basics/latest/gravity-force-lab-basics_en.html" target="_blank">Click here to
run "Gravity Force Lab: Basics".</a>
...
(5) Open in the browser: `http://localhost/gravity-force-lab-basics/gravity-force-lab-basics_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/gravity-force-lab-basics/build/adapted-from-phet/gravity-force-lab-basics_en_adapted-from-phet.html` (You will
